...
// Ported from index.html's adOpenAny block (lines ~74-93).
      ...
      <div style={cardStyle}>
        <div
          style={{
            ...
            backgroundImage: ad.imageUrl ? `url(${ad.imageUrl})` : 'none'
          }}
        >
...
const textWrapStyle: CSSProperties = { position: 'absolute', insetInlineEnd: 18, insetInlineStart: 18, bottom: 16 };
