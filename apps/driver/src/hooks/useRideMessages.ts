...
// In-app chat, scoped to one ride -- the driver-side twin of the rider app's
// hook of the same name (0021_phone_privacy_and_ride_messages.sql). Writes
// go through send_ride_message() (checks the ride is live and stamps
