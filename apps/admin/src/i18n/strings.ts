...
export const AR = {
  ...
  navUsers: 'المستخدمون', navDrivers: 'السائقون', navAvailable: 'المتاحون الآن', navRatings: 'التقييمات',
  navPlaces: 'الأماكن والشوارع', navPricing: 'التسعيرة', navMessages: 'الرسائل', navAds: 'الإعلانات', navSettings: 'الإعدادات',
  ttlUsers: 'إدارة المستخدمين', ttlDrivers: 'إدارة السائقين', ttlAvailable: 'السائقون المتاحون الآن', ttlRatings: 'تقييمات الركاب',
...
export const EN = {
  ...
  navUsers: 'Riders', navDrivers: 'Drivers', navAvailable: 'Available now', navRatings: 'Ratings',
  navPlaces: 'Places & streets', navPricing: 'Pricing', navMessages: 'Messages', navAds: 'Announcements', navSettings: 'Settings',
  ttlUsers: 'Rider management', ttlDrivers: 'Driver management', ttlAvailable: 'Drivers available now', ttlRatings: 'Rider ratings',
